...
metapkgs=(./sdata/dist-arch/illogical-impulse-{audio,backlight,basic,fonts-themes,gnome,kde,portal,python,screencapture,toolkit,widgets})
...
metapkgs+=(./sdata/dist-arch/illogical-extras)
